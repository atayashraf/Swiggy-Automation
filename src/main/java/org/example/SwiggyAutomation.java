...
public class SwiggyAutomation {
    ...
    private static void safeClick(WebDriver driver, By by, String elementName) throws InterruptedException {
        try {
    ...
    private static void safeSendKeys(WebDriver driver, By by, String text, String elementName) throws InterruptedException {
        try {
            WebElement element = driver.findElement(by);
            element.clear();
            ...
            System.err.println("Error sending keys to " + elementName + ": " + e.getMessage());
            throw e;
        }
    }
    public static void main(String[] args) throws InterruptedException {

        // Please enter your Swiggy registered phone number here
        String phoneNumber = "6393890113"; // Example: "9876543210"
        ...
        System.out.println("   Waiting for 30 seconds for OTP entry...");
        try (java.util.Scanner scanner = new java.util.Scanner(System.in)) {
            System.out.println("   Press Enter after entering the OTP...");
            scanner.nextLine();
        }
